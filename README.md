...
git clone https://github.com/Michelle-bit-web/join.git
...
Use the `--prod` flag for optimized production builds.


## 📌 To-Do & Ideas

- [ ] 🖼️ Upload option for user avatars or task attachments  
